...
import project.ensa.Builders.CompanyBuilder;
import project.ensa.Builders.SupplyChainBuilder;
...
/**
 * Système de gestion de chaîne logistique pour entreprises manufacturières
 *
 * Contexte: Une entreprise possède plusieurs usines dans différents pays.
 * Chaque usine a des entrepôts avec des stocks de produits et des employés.
 * Les entreprises peuvent former des partenariats commerciaux pour optimiser
...
public class SupplyChainManagementTest {
    ...
    public void showCompanyStructure() {
        Company company = new CompanyBuilder()
                ...
                // (pays, sto4ck_entrepot1, employés_entrepot1, stock_entrepot2, ...)
